...
export default function Home() {
  return (
    <main className="flex min-h-dvh flex-col items-center justify-center gap-4 bg-zinc-50 px-6 text-center">
      <h1 className="text-xl font-semibold text-zinc-900">Marbury Studios</h1>
      ...
      <Link
        href="/interview/new"
        className="rounded-full bg-zinc-900 px-6 py-2.5 text-sm font-medium text-white transition-transform active:scale-95"
      >
        Start
      </Link>
    </main>
